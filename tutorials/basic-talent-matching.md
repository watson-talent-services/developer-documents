...
We've made this into a checklist so you can follow along. You can also grab this file, and open it with Postman to set all the right fields (you'll still need to get your ID/Secret and upload the files) - [Postman file for this tutorial](https://github.ibm.com/WatsonTalent/TMS-Developer-Experience/blob/Add-Postman-File-For-Tutorial/tutorials/WTP-Talent%20Match%20v1.postman_collection.json).
